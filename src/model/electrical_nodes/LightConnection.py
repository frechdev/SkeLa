...
class LightConnection(ElectricalNode):
    ...
    def get_svg_definition_string(self):
        ...
        definition_string_list.append(f'<circle cx="10" cy="10" r="10" fill="none" stroke="black" stroke-width="{stroke_width}" />')
        definition_string_list.append(f'<line x1="0" y1="0" x2="20" y2="20" stroke="black" stroke-width="{stroke_width}" />')
