...
class SocketPower(ElectricalNode):
    ...
    def get_svg_definition_string(self):
        ...
        definition_string_list.append(f'<line x1="10" y1="0" x2="10" y2="20" stroke="black" stroke-width="{stroke_width}" />')
        definition_string_list.append(f'<line x1="0" y1="10" x2="10" y2="10" stroke="black" stroke-width="{stroke_width}" />')
        definition_string_list.append(f'<path d="M20 0 A10 10 0 0 0 20 20" fill="none" stroke="black" stroke-width="{stroke_width}" />')
        ...
        definition_string_list.append(f'<line x1="0" y1="10" x2="10" y2="10" stroke="black" stroke-width="{stroke_width}" />')
        definition_string_list.append(f'<path d="M20 0 A10 10 0 0 0 20 20" fill="none" stroke="black" stroke-width="{stroke_width}" />')
        definition_string_list.append(f'<line x1="12" y1="20" x2="16" y2="16" stroke="black" stroke-width="{stroke_width}" />')
